...
public class BuildingAddRecipeTrigger extends SimpleCriterionTrigger<BuildingAddRecipeTrigger.BuildingAddRecipeTriggerInstance> {
    ...
    public static record BuildingAddRecipeTriggerInstance(Optional<ContextAwarePredicate> player,
                                                          List<ItemPredicate> outputItemPredicates,
                                                          int craftingSize) implements SimpleInstance {
