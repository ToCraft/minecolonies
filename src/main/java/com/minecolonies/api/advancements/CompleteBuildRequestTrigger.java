...
public class CompleteBuildRequestTrigger extends SimpleCriterionTrigger<CompleteBuildRequestTrigger.CompleteBuildRequestTriggerInstance> {
    ...
    public static record CompleteBuildRequestTriggerInstance(Optional<ContextAwarePredicate> player,
                                                             Optional<String> hutName,
                                                             int level) implements SimpleInstance {
