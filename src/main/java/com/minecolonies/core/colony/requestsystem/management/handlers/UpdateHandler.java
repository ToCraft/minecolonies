...
import com.minecolonies.core.colony.requestsystem.management.handlers.update.implementation.ResetRSToRemoveAssistantCookResolver;
...
public class UpdateHandler implements IUpdateHandler {
    ...
    public UpdateHandler(final IStandardRequestManager manager) {
